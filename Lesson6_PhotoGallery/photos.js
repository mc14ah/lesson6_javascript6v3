...
function previewFive() {
   ...
   //local first element where the tag is article assign to a variable
   ...
   lastFigure.syle.position = "absolute";
   ...
   articleEl.insertBerfore(firstFigure, document.getElementById("fig1"));
